...
Plugin URI: https://github.com/LuisAlejandroRamos/Pasareladepago
...
add_filter( 'woocommerce_payment_gateways', 'Agregar_Pasarela' );
function CG_Agregar_Pasarela( $gateways ) {
	$gateways[] = 'LARR_Gateway';
	return $gateways;
}

add_action( 'plugins_loaded', 'init_pasarela_class' );
function init_pasarela_class() {

    class LARR_Gateway extends WC_Payment_Gateway {
        ...
        public function __construct() {
            ...
            $this->method_description = 'ESTE ES LA PASARELA DE PAGO';
        ...
        public function payment_scripts() {
            ...
            wp_enqueue_script( 'woocommerce_LARR' );
